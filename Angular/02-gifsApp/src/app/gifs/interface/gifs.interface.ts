// To parse this data:
//
//   import { Convert, SerchGIFResponse } from "./file";
//
//   const serchGIFResponse = Convert.toSerchGIFResponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SerchGIFResponse {
    data:       Gif[];
...
export class Convert {
    public static toSerchGIFResponse(json: string): SerchGIFResponse {
        return cast(JSON.parse(json), r("SerchGIFResponse"));
    }

    public static serchGIFResponseToJson(value: SerchGIFResponse): string {
        return JSON.stringify(uncast(value, r("SerchGIFResponse")), null, 2);
    }
}
